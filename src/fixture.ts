 ...
 * in this package's baas-env.defaultOpenclawVersion field (2026.6.11).
...
export const DEFAULT_OPENCLAW_VERSION = '2026.6.11'
 ...
 */
export const OPENCLAW_2026_6_11_PATH =
  '/opt/homebrew/bin:/opt/homebrew/opt/node@24/bin:/opt/homebrew/sbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin'

export function fixturePath(): string {
  if (process.env.BAAS_FIXTURE_PATH) return process.env.BAAS_FIXTURE_PATH
  if (existsSync('/opt/homebrew/bin/openclaw')) return OPENCLAW_2026_6_11_PATH
