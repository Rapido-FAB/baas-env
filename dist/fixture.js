 ...
 */
export const OPENCLAW_2026_6_11_PATH = '/opt/homebrew/bin:/opt/homebrew/opt/node@24/bin:/opt/homebrew/sbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin';
export function fixturePath() {
    ...
    if (existsSync('/opt/homebrew/bin/openclaw'))
        return OPENCLAW_2026_6_11_PATH;
